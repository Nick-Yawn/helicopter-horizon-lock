...
[QGVAR(rollLimit), "SLIDER",
    ["Roll limit", "Degrees of bank cancelled before the view starts following the aircraft. The engine stops head roll at 45 degrees, so 45 keeps the horizon level at any bank it can."],
